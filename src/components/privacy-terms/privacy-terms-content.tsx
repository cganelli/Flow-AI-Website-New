          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-lg border border-gray-100 p-8">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <h3 className="text-2xl font-semibold mb-4 text-gray-900">9. Changes to Terms</h3>
                <p className="mb-6">
                ...
                <h3 className="text-2xl font-semibold mb-4 text-gray-900">10. Governing Law</h3>
                <p className="mb-6">
                ...
                <h3 className="text-2xl font-semibold mb-4 text-gray-900">11. Contact Information</h3>
                <p className="mb-6">
